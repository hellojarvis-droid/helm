...
export default function PrivacyPage() {
  return (
    <LegalLayout
      ...
      intro="What we collect, why, who else touches it. Plain English. The lawyer-reviewed formal policy lands before public launch and replaces this document."
    >
      <LegalSection title="Identity">
        <p>
          We collect your email + a Supabase-issued user ID. That&apos;s our handle on you. Email is
          used for auth, billing receipts via Stripe, and product correspondence we&apos;d send
          anyway. We do not sell email addresses. We do not run a marketing email program.
        </p>
      </LegalSection>

      <LegalSection title="What you tell us by using Helm">
      ...
      <LegalSection title="What you don't give us">
        <ul className="list-disc list-inside space-y-2">
          <li>
            Raw OAuth credentials for Gmail/Slack/etc. Composio holds those; we ask for ephemeral
            tokens scoped to the action.
          </li>
          <li>Stripe payment method details. Stripe holds those; we hold a customer ID pointer.</li>
          <li>
      ...
      <LegalSection title="How long we keep it">
        <p>
          Live for the lifetime of your account + 30 days post-cancellation so you can export. After
          that, it&apos;s deleted. Aggregated, anonymous metrics may persist for product analytics.
        </p>
      </LegalSection>
